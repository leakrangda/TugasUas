...
<html lang="en">
  <head>
    ...
    $q = "select id_barang, nama as barang from barang"; 
    $r = "select id_pelanggan, nama_pelanggan as pelanggan from pelanggan";
    ...
    $resultSet2 = mysqli_query($koneksi, $r);
    if(!$resultSet2){
        //gagal ambil data, check apa yang gagal.
        echo(mysqli_error($koneksi));
    }
...
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style></head>
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      ...
      <input class="form-control" class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search">
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"><div class="chartjs-size-monitor" style="position: absolute; inset: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <form action="../sistem/transaksi_proses.php" method="post">
                <div class="form-group">
                    <label class="form-label" for="nama">Nama Tansaksi</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="barang" required>
                        ...
                        <option value="<?php echo($data['id_barang']);?>"><?php echo($data['barang']);?></option>
                    <?php } ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="pelanggan" required>
                        <?php while($data=mysqli_fetch_assoc($resultSet2)){ ?>
                            <option value="<?php echo($data['id_pelanggan']);?>"><?php echo($data['pelanggan']);?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="form-group">
                    <input class="form-control" type="submit" value="buat" />
